        ...
        <div className="bg-white dark:bg-[#161B26] border border-gray-100 dark:border-slate-800 rounded-2xl p-6 shadow-sm transition-colors">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center pb-4 border-b border-gray-50 dark:border-slate-800/50 transition-colors">
              <div>
                <p className="font-bold text-sm text-slate-800 dark:text-white transition-colors">
                  García Family
                </p>
              ...
              <div className="text-right">
                <p className="font-bold text-sm text-rose-600 dark:text-rose-400 transition-colors">
                  €1250
                </p>
                <span className="text-[10px] font-semibold text-rose-500 bg-rose-50 dark:bg-rose-500/10 dark:text-rose-400 px-2 py-0.5 rounded transition-colors">
                  3 mo
                </span>
              </div>
            </div>
